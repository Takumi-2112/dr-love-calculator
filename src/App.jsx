      ...
      {touchButtonOne >= 1 && touchButtonTwo >= 1 ? (
        <>
          ...
          <div className="content-div">
            ...
            {touchButtonOne === 1 && touchButtonTwo === 0 ? (
              <div className="welcome-dr-div">
                <img className="welcome-dr-img" src={welcomeDr} alt="" />
              </div>
            ) : null}
            {touchButtonOne === 0 && touchButtonTwo === 1 ? (
              <div className="welcome-dr-div">
                <img className="welcome-dr-img" src={welcomeDr} alt="" />
              </div>
            ) : null}
            {touchButtonOne === 1 && touchButtonTwo === 1 ? (
              <div className="gene-div">
                <img className="gene-img" src={drGene} alt="" />
              </div>
            ) : null}
            {touchButtonOne > 1 && touchButtonTwo === 1 ? (
              <div className="gene-div">
            ...
            {touchButtonOne > 1 && touchButtonTwo > 1 ? (
              <div className="dr-love-div">
                <img className="dr-love-img" src={drLove} alt="" />
              </div>
            ) : null}
          </div>
          <TouchButtonTwo
            touchButtonTwoToggler={touchButtonTwoToggler}
            touchButtonTwo={touchButtonTwo}
          />
        </>
      ) : (
